...
export interface ProductSliceProps {
  ...
  assignment: IMapProductProps; // **Changed: No longer nullable**
}
...
const initialState: ProductSliceProps = {
  ...
  assignment: {
    // **Changed: Initialize as an empty object with required properties**
    demo_product_id: "", // Or null, depending on your IMapProductProps definition
    user_id: "", // Or null
  },
};
...
const productSlice = createSlice({
  ...
  reducers: {
    ...
    // **Changed: IMapProductProps here no longer accepts null**
    handleDemoAssignment: (state, action: PayloadAction<IMapProductProps>) => {

...
export const DemoPage = () => {
  ...
  return (
    <div className="space-y-5">
          ...
          <div className="flex items-center gap-3 sm:gap-5 w-full sm:w-1/3">
            <div className="flex flex-1 gap-2 items-center border border-gray-500 rounded-lg px-3">
              ...
              <input
                ...
                className="bg-transparent placeholder:text-gray-500 w-full py-2 text-sm sm:text-base focus:outline-none"
              />
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3 sm:gap-5 w-full sm:flex-1">
            {role === "admin" && (
              <>
                <AppButton
                  fullWidth
                ...
                >
                  <AiOutlinePlus className="size-4 sm:size-6" />
                  <span className="ml-1">New demo</span>
                </AppButton>
              </>
            )}
            <AppSelect
      ...
      {isLoading && <AppLoader />}
      <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-12 mt-5 gap-x-4 gap-y-10">
        {!isLoading &&
          currentItems &&
          currentItems.map(
            ({
              ...
              <div
                key={_id}
                className="col-span-full xs:col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-2 xl:col-span-3"
              >
                <DemoCard
      ...
      {itemsPerPage > 12 &&
        ...
        filteredProducts.length > 0 && (
          <div className="col-span-12 mt-8 flex justify-center sm:justify-end">
            <ReactPaginate
              breakLabel="..."
              nextLabel="Next >"
              previousLabel="< Prev"
              ...
              containerClassName="flex flex-wrap gap-1 sm:gap-2 items-center justify-center"
              pageClassName="rounded border text-sm sm:text-lg px-2 sm:px-4 py-1 sm:py-2 hover:bg-gray-100"
              pageLinkClassName="text-gray-500"
              activeClassName="bg-gray-200 active:text-white"
              previousClassName="rounded px-2 sm:px-4 py-1 sm:py-2 bg-gray-200 hover:bg-gray-300"
              nextClassName="rounded px-2 sm:px-4 py-1 sm:py-2 bg-gray-200 hover:bg-gray-300"
              breakClassName="rounded px-2 sm:px-4 py-1 sm:py-2 text-gray-500"
